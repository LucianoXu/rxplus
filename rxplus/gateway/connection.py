...
class Connection:
    ...
    _duplex: Optional[Any] = field(default=None, repr=False)
    _ws_client: Optional[Any] = field(default=None, repr=False)
    _disposables: CompositeDisposable = field(default_factory=CompositeDisposable, repr=False)
